...
public class Ejercicio2B
{
	...
	private static final String CUANTOS_ANOS_TIENES = "¿Cuántos años tienes?"; //Refactorizamos como Constante  las preguntas.
	...
	public static void preguntar(String pregunta) //Dandole tipo String, y cambiandole el parametro a preguntar que tenemos como constante para tenerlo en todas las 
	{											 //lineas. 
